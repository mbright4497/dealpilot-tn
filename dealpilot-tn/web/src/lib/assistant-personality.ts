export type AssistantStyle = 'joyful' | 'straight' | 'calm' | 'executive' | 'friendly_tn' | 'friendly-tn'
...
export const PERSONALITY_OPTIONS: { value: AssistantStyle; label: string; description: string; exampleGreeting: string }[] = [
  ...
  { value: 'friendly_tn', label: 'Friendly TN', description: 'Warm, conversational Tennessee-style friendly assistant.', exampleGreeting: "Mornin'! I've got your list ready - let's handle it." },
]

export function getDefaultStyle(): AssistantStyle { return 'friendly_tn' }
