...
export const FIELD_COORDS: PDFFieldCoord[] = [
  ...
  { fieldId: 'buyer1_offer_time',      page: 11, x: 350,  y: 475,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'buyer1_offer_ampm',      page: 11, x: 460,  y: 475,  type: 'text',     fontSize: 9, maxWidth: 40  },
  { fieldId: 'buyer2_offer_date',      page: 11, x: 700,  y: 475,  type: 'text',     fontSize: 9, maxWidth: 120 },
  { fieldId: 'buyer2_offer_time',      page: 11, x: 870,  y: 475,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'buyer2_offer_ampm',      page: 11, x: 980,  y: 475,  type: 'text',     fontSize: 9, maxWidth: 40  },
  { fieldId: 'seller_response_accepts_chk', page: 11, x: 188, y: 575, type: 'checkbox', fontSize: 9, maxWidth: 20 },
  { fieldId: 'seller_response_counters_chk', page: 11, x: 188, y: 603, type: 'checkbox', fontSize: 9, maxWidth: 20 },
  { fieldId: 'seller_response_rejects_chk', page: 11, x: 188, y: 631, type: 'checkbox', fontSize: 9, maxWidth: 20 },
  { fieldId: 'seller1_date',           page: 11, x: 153,  y: 675,  type: 'text',     fontSize: 9, maxWidth: 120 },
  { fieldId: 'seller1_time',           page: 11, x: 350,  y: 675,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'seller1_ampm',           page: 11, x: 460,  y: 675,  type: 'text',     fontSize: 9, maxWidth: 40  },
  { fieldId: 'seller2_date',           page: 11, x: 700,  y: 675,  type: 'text',     fontSize: 9, maxWidth: 120 },
  { fieldId: 'seller2_time',           page: 11, x: 870,  y: 675,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'seller2_ampm',           page: 11, x: 980,  y: 675,  type: 'text',     fontSize: 9, maxWidth: 40  },
  { fieldId: 'binding_acknowledged_by', page: 11, x: 153,  y: 755,  type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'binding_agreement_date',  page: 11, x: 153,  y: 780,  type: 'text',     fontSize: 9, maxWidth: 120 },
  { fieldId: 'binding_agreement_time',  page: 11, x: 350,  y: 780,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'binding_agreement_ampm',  page: 11, x: 460,  y: 780,  type: 'text',     fontSize: 9, maxWidth: 40  },
  { fieldId: 'listing_firm_name',      page: 11, x: 232,  y: 1045, type: 'text',     fontSize: 9, maxWidth: 520 },
  { fieldId: 'listing_firm_address',   page: 11, x: 153,  y: 898,  type: 'text',     fontSize: 9, maxWidth: 520 },
  { fieldId: 'listing_firm_license',   page: 11, x: 153,  y: 921,  type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'listing_firm_phone',     page: 11, x: 153,  y: 944,  type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'listing_licensee_name',  page: 11, x: 153,  y: 967,  type: 'text',     fontSize: 9, maxWidth: 520 },
  { fieldId: 'listing_licensee_number', page: 11, x: 153, y: 990,  type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'listing_licensee_email', page: 11, x: 153,  y: 1013, type: 'text',     fontSize: 9, maxWidth: 520 },
  { fieldId: 'listing_licensee_cell',  page: 11, x: 153,  y: 1036, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_firm_name',       page: 11, x: 778,  y: 875,  type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_firm_address',    page: 11, x: 778,  y: 898,  type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_firm_license',    page: 11, x: 778,  y: 921,  type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_firm_phone',      page: 11, x: 778,  y: 944,  type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_licensee_name',   page: 11, x: 778,  y: 967,  type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_licensee_number', page: 11, x: 778,  y: 990,  type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_licensee_email',  page: 11, x: 778,  y: 1013, type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_licensee_cell',   page: 11, x: 778,  y: 1036, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'hoa_name',               page: 11, x: 153,  y: 1090, type: 'text',     fontSize: 9, maxWidth: 360 },
  { fieldId: 'hoa_phone',              page: 11, x: 153,  y: 1130, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'hoa_email',              page: 11, x: 778,  y: 1130, type: 'text',     fontSize: 9, maxWidth: 520 },
]
