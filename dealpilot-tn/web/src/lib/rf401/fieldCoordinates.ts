...
export const FIELD_COORDS: PDFFieldCoord[] = [
  ...
  { fieldId: 'buyer1_offer_time',      page: 11, x: 365,  y: 475,  type: 'text',     fontSize: 9, maxWidth: 80  },
  ...
  { fieldId: 'buyer2_offer_time',      page: 11, x: 880,  y: 475,  type: 'text',     fontSize: 9, maxWidth: 80  },
  ...
  { fieldId: 'seller1_time',           page: 11, x: 365,  y: 832,  type: 'text',     fontSize: 9, maxWidth: 80  },
  ...
  { fieldId: 'seller2_time',           page: 11, x: 880,  y: 832,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'seller2_ampm',           page: 11, x: 1020, y: 832,  type: 'text',     fontSize: 9, maxWidth: 40  },
  { fieldId: 'binding_acknowledged_by', page: 11, x: 153,  y: 912,  type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'binding_agreement_date',  page: 11, x: 153,  y: 934,  type: 'text',     fontSize: 9, maxWidth: 120 },
  { fieldId: 'binding_agreement_time',  page: 11, x: 390,  y: 934,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'binding_agreement_ampm',  page: 11, x: 496,  y: 934,  type: 'text',     fontSize: 9, maxWidth: 40  },
  ...
  { fieldId: 'listing_firm_license',   page: 11, x: 271,  y: 1091, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'listing_firm_phone',     page: 11, x: 298,  y: 1115, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'listing_licensee_name',  page: 11, x: 266,  y: 1138, type: 'text',     fontSize: 9, maxWidth: 520 },
  { fieldId: 'listing_licensee_number', page: 11, x: 339, y: 1163, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'listing_licensee_email', page: 11, x: 256,  y: 1186, type: 'text',     fontSize: 9, maxWidth: 520 },
  { fieldId: 'listing_licensee_cell',  page: 11, x: 327,  y: 1210, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_firm_name',       page: 11, x: 759,  y: 1044, type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_firm_address',    page: 11, x: 830,  y: 1066, type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_firm_license',    page: 11, x: 795,  y: 1091, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_firm_phone',      page: 11, x: 821,  y: 1114, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_licensee_name',   page: 11, x: 792,  y: 1138, type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_licensee_number', page: 11, x: 869,  y: 1164, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_licensee_email',  page: 11, x: 780,  y: 1186, type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_licensee_cell',   page: 11, x: 852,  y: 1211, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'hoa_name',               page: 11, x: 120,  y: 1258, type: 'text',     fontSize: 9, maxWidth: 360 },
  { fieldId: 'hoa_phone',              page: 11, x: 182,  y: 1283, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'hoa_email',              page: 11, x: 703,  y: 1282, type: 'text',     fontSize: 9, maxWidth: 520 },
]
