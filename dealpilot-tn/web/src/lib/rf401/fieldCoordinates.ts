...
export const FIELD_COORDS: PDFFieldCoord[] = [
  ...
  { fieldId: 'property_address',       page: 1,  x: 600,  y: 415,  type: 'text',     fontSize: 9, maxWidth: 600 },
  ...
  { fieldId: 'property_county',        page: 1,  x: 153,  y: 462,  type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'deed_book',              page: 1,  x: 970,  y: 462,  type: 'text',     fontSize: 9, maxWidth: 100 },
  { fieldId: 'deed_pages',             page: 1,  x: 1130, y: 462,  type: 'text',     fontSize: 9, maxWidth: 100 },
  { fieldId: 'instrument_number',      page: 1,  x: 153,  y: 485,  type: 'text',     fontSize: 9, maxWidth: 400 },
  ...
  { fieldId: 'expense_mod_line1',      page: 3,  x: 153,  y: 1125, type: 'text',     fontSize: 9, maxWidth: 900 },
  { fieldId: 'expense_mod_line2',      page: 3,  x: 153,  y: 1143, type: 'text',     fontSize: 9, maxWidth: 900 },
  { fieldId: 'expense_mod_line3',      page: 3,  x: 153,  y: 1161, type: 'text',     fontSize: 9, maxWidth: 900 },
  { fieldId: 'expense_mod_line4',      page: 3,  x: 153,  y: 1179, type: 'text',     fontSize: 9, maxWidth: 900 },
  ...
  // ─── PAGE 8 ───
  { fieldId: 'hpp_paid_by',            page: 8,  x: 340,  y: 1075, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'hpp_amount',             page: 8,  x: 768,  y: 1075, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'hpp_provider',           page: 8,  x: 490,  y: 1093, type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'hpp_ordered_by',         page: 8,  x: 300,  y: 1111, type: 'text',     fontSize: 9, maxWidth: 500 },
  { fieldId: 'hpp_waived_chk',         page: 8,  x: 188,  y: 1128, type: 'checkbox', fontSize: 9, maxWidth: 20  },
  ...
  { fieldId: 'buyer1_offer_date',      page: 11, x: 153,  y: 520,  type: 'text',     fontSize: 9, maxWidth: 120 },
  { fieldId: 'buyer1_offer_time',      page: 11, x: 350,  y: 520,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'buyer1_offer_ampm',      page: 11, x: 460,  y: 520,  type: 'text',     fontSize: 9, maxWidth: 40  },
  { fieldId: 'buyer2_offer_date',      page: 11, x: 700,  y: 520,  type: 'text',     fontSize: 9, maxWidth: 120 },
  { fieldId: 'buyer2_offer_time',      page: 11, x: 870,  y: 520,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'buyer2_offer_ampm',      page: 11, x: 980,  y: 520,  type: 'text',     fontSize: 9, maxWidth: 40  },
  { fieldId: 'seller_response_accepts_chk', page: 11, x: 188, y: 620, type: 'checkbox', fontSize: 9, maxWidth: 20 },
  { fieldId: 'seller_response_counters_chk', page: 11, x: 188, y: 648, type: 'checkbox', fontSize: 9, maxWidth: 20 },
  { fieldId: 'seller_response_rejects_chk', page: 11, x: 188, y: 676, type: 'checkbox', fontSize: 9, maxWidth: 20 },
  { fieldId: 'seller1_date',           page: 11, x: 153,  y: 720,  type: 'text',     fontSize: 9, maxWidth: 120 },
  { fieldId: 'seller1_time',           page: 11, x: 350,  y: 720,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'seller1_ampm',           page: 11, x: 460,  y: 720,  type: 'text',     fontSize: 9, maxWidth: 40  },
  { fieldId: 'seller2_date',           page: 11, x: 700,  y: 720,  type: 'text',     fontSize: 9, maxWidth: 120 },
  { fieldId: 'seller2_time',           page: 11, x: 870,  y: 720,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'seller2_ampm',           page: 11, x: 980,  y: 720,  type: 'text',     fontSize: 9, maxWidth: 40  },
  { fieldId: 'binding_acknowledged_by', page: 11, x: 153,  y: 800,  type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'binding_agreement_date',  page: 11, x: 153,  y: 825,  type: 'text',     fontSize: 9, maxWidth: 120 },
  { fieldId: 'binding_agreement_time',  page: 11, x: 350,  y: 825,  type: 'text',     fontSize: 9, maxWidth: 80  },
  { fieldId: 'binding_agreement_ampm',  page: 11, x: 460,  y: 825,  type: 'text',     fontSize: 9, maxWidth: 40  },
  { fieldId: 'listing_firm_name',      page: 11, x: 153,  y: 920,  type: 'text',     fontSize: 9, maxWidth: 520 },
  { fieldId: 'listing_firm_address',   page: 11, x: 153,  y: 943,  type: 'text',     fontSize: 9, maxWidth: 520 },
  { fieldId: 'listing_firm_license',   page: 11, x: 153,  y: 966,  type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'listing_firm_phone',     page: 11, x: 153,  y: 989,  type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'listing_licensee_name',  page: 11, x: 153,  y: 1012, type: 'text',     fontSize: 9, maxWidth: 520 },
  { fieldId: 'listing_licensee_number', page: 11, x: 153, y: 1035, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'listing_licensee_email', page: 11, x: 153,  y: 1058, type: 'text',     fontSize: 9, maxWidth: 520 },
  { fieldId: 'listing_licensee_cell',  page: 11, x: 153,  y: 1081, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_firm_name',       page: 11, x: 778,  y: 920,  type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_firm_address',    page: 11, x: 778,  y: 943,  type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_firm_license',    page: 11, x: 778,  y: 966,  type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_firm_phone',      page: 11, x: 778,  y: 989,  type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_licensee_name',   page: 11, x: 778,  y: 1012, type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_licensee_number', page: 11, x: 778,  y: 1035, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'buying_licensee_email',  page: 11, x: 778,  y: 1058, type: 'text',     fontSize: 9, maxWidth: 400 },
  { fieldId: 'buying_licensee_cell',   page: 11, x: 778,  y: 1081, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'hoa_name',               page: 11, x: 153,  y: 1135, type: 'text',     fontSize: 9, maxWidth: 360 },
  { fieldId: 'hoa_phone',              page: 11, x: 153,  y: 1175, type: 'text',     fontSize: 9, maxWidth: 200 },
  { fieldId: 'hoa_email',              page: 11, x: 778,  y: 1175, type: 'text',     fontSize: 9, maxWidth: 520 },
]
