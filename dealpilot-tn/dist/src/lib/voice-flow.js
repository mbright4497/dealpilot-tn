...
exports.nextPrompt = exports.VOICE_STEPS = void 0;
exports.VOICE_STEPS = [
...
const nextPrompt = (currentStep) => {
    const s = exports.VOICE_STEPS.find(st => st.step === currentStep + 1);
    return s ? { nextStep: s.step, prompt: s.prompt, field: s.field } : null;
};
exports.nextPrompt = nextPrompt;
exports.default = { VOICE_STEPS: exports.VOICE_STEPS, nextPrompt: exports.nextPrompt };
