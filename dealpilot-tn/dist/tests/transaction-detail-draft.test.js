...
const draftTemplate_1 = require("@/lib/draftTemplate");
describe('buildDraftTemplate', () => {
    ...
    it('personalizes lender draft body and includes lender email', () => {
        const contacts = [{ role: 'Lender', name: 'Lenny', email: 'lender@example.com' }];
        const template = (0, draftTemplate_1.buildDraftTemplate)('lender', baseTransaction, contacts);
    ...
    it('falls back to warning placeholder when title contact email missing', () => {
        const template = (0, draftTemplate_1.buildDraftTemplate)('title', baseTransaction, []);
    ...
    it('collects all party emails for closing reminders', () => {
        ...
        const template = (0, draftTemplate_1.buildDraftTemplate)('closing', baseTransaction, contacts);
